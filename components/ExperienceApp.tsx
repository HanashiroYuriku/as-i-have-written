...
export default function ExperienceApp() {
  ...
  return (
    <div className="w-full h-full bg-[#ece5d3] text-[#4a3b32] flex flex-col md:flex-row overflow-y-auto md:overflow-hidden relative shadow-[inset_0_0_50px_rgba(0,0,0,0.1)]">
      ...
      <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 -translate-x-1/2 bg-[#d3c5af]/80 pointer-events-none z-20"></div>
      ...
      <AnimatePresence custom={direction} mode="wait">
        ...
        >
          {/* --- HALAMAN KIRI  --- */}
          <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col relative border-b-2 md:border-b-0 border-[#d3c5af]/80 z-10">
