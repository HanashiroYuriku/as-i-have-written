...
export const projects: Project[] = [
  {
    ...
    date: 'July 2026',
    description: 'A .NET (C#) Backend API template designed with Clean Architecture, CQRS (Command Query Responsability Segregation), and Vertical Slice Architecture. This project focuses on scalability, security, and seamless team collaboration. Unit testing and dockerize is not implement yet.',
